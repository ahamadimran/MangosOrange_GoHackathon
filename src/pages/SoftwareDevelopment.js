        ...
        <div class="album py-5 bg-light">
            <div class="container"> 
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 text-center">
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                           <img src="img/resources/custom-development.jpg" alt="Custom Software Development" height="200px" width="100%"/>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                           <img src="img/resources/tech-assist.jpg" alt="Tech Assistance for Startup" height="200px" width="100%"/>
                            <div class="card-body">
        ...
        <div class="album py-5 bg-light">
            <div class="container"> 
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 text-center">
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                           <img src="img/resources/ui-ux.jpg" alt="UI/UX Designing" height="200px" width="100%"/>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                           <img src="img/resources/e-commerce.jpg" alt="E-Commerce Development" height="200px" width="100%"/>
                            <div class="card-body">
                                <h4>E-Commerce</h4>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                           <img src="img/resources/custom-lms.jpg" alt="Custom LMS" height="200px" width="100%"/>
                            <div class="card-body">
                                <h4>Custom LMS</h4>
                            </div>
                        </div>
